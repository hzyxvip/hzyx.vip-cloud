export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  admin: [
    'unit_view', 'unit_add', 'unit_edit', 'unit_delete', 'unit_sync',
    'product_view', 'product_add', 'product_edit', 'product_delete', 'product_audit',
    'purchase_view', 'purchase_add', 'purchase_edit', 'purchase_delete', 'purchase_audit', 'purchase_inbound',
    'sales_view', 'sales_add', 'sales_edit', 'sales_delete', 'sales_audit', 'sales_outbound',
    'warehouse_view', 'warehouse_in', 'warehouse_out', 'warehouse_transfer', 'warehouse_check',
    'finance_view', 'finance_receipt', 'finance_payment', 'finance_report',
