...
const form = ref({ orderNo: '', invoiceNo: '', amount: '', date: '' })
</script>
    ...
    <div class="form-card">
      <el-form :model="form" label-width="100px">
        <div class="form-row">
          ...
          <el-form-item label="开票日期"><el-date-picker v-model="form.date" type="date" /></el-form-item>
        </div>
        <el-form-item label="开票金额"><el-input v-model="form.amount" placeholder="¥" /></el-form-item>
      </el-form>
    </div>
  </div>
</template>
