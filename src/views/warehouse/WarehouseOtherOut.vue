...
const outTypeOptions = [
  { label: '报损出库', value: 'damage' },
  { label: '领用出库', value: 'receive' },
  { label: '赠送出库', value: 'gift' },
...
const handleSave = () => {
  ...
  // 保存到 localStorage
  const stored = localStorage.getItem('warehouseOutList')
  const list = stored ? JSON.parse(stored) : []
  list.unshift(outOrder)
  localStorage.setItem('warehouseOutList', JSON.stringify(list))
      ...
      <div class="form-header">
        <div class="form-row">
          ...
          <el-form-item label="出库类别" required>
            <el-select v-model="form.outType" placeholder="请选择类别" style="width: 100%;">
              <el-option 
