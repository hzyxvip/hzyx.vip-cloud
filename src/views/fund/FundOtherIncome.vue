...
const form = ref({ type: '', amount: '', date: '', account: '', remark: '' })
</script>
  ...
  <div class="page-container">
    ...
    <div class="form-card">
      <el-form :model="form" label-width="100px">
        <div class="form-row">
          <el-form-item label="收入类型"><el-select v-model="form.type"><el-option label="利息收入" value="interest" /></el-select></el-form-item>
