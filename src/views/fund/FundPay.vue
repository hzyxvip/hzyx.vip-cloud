...
const handleSave = () => {
  ...
  ElMessage.success(`付款单 ${doc.id} 已保存`)
  router.push('/fund')
}
      ...
      <el-form :model="form" label-width="100px">
        <div class="form-row">
          <el-form-item label="供应商" required>
            <el-select v-model="form.partner" filterable placeholder="请选择供应商" style="width: 100%">
        ...
        <div class="form-row">
          ...
          <el-form-item label="关联订单">
            <el-input v-model="form.sourceOrderNo" placeholder="采购订单号（可选）" />
          </el-form-item>
        </div>
