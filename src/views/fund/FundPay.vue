...
const form = ref({ supplier: '', amount: '', date: '', account: '' })
</script>
  ...
  <div class="page-container">
    ...
    <div class="form-card">
      <el-form :model="form" label-width="100px">
        <div class="form-row">
          <el-form-item label="供应商"><el-select v-model="form.supplier"><el-option label="北京医疗器械有限公司" value="supplier" /></el-select></el-form-item>
        ...
        <el-form-item label="结算账户"><el-select v-model="form.account"><el-option label="工商银行" value="icbc" /></el-select></el-form-item>
      </el-form>
    </div>
  </div>
</template>
