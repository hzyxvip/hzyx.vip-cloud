...
const form = ref({ preReceiptNo: '', amount: '', reason: '', date: '' })
</script>
  ...
  <div class="page-container">
    ...
    <div class="form-card">
      <el-form :model="form" label-width="100px">
        <div class="form-row">
          <el-form-item label="原预收单号"><el-input v-model="form.preReceiptNo" /></el-form-item>
          <el-form-item label="退款金额"><el-input v-model="form.amount" /></el-form-item>
